...
namespace NDbfReader
{
    ...
    /// </summary>
    [DebuggerDisplay("Currency {Name}")]
    public class CurrencyColumn : Column<decimal?>
    {
        private readonly decimal _diviser;

        /// <summary>
        /// Initializes a new instance with the specified name, offset and decimal precision.
        /// </summary>
        ...
        public CurrencyColumn(string name, int offset, int size, int decimalPrecision)
            : base(name, offset, size, decimalPrecision)
        {
            _diviser = (decimal)Math.Pow(10, decimalPrecision);
        }
        ...
        {
            return BitConverter.ToInt64(buffer, offset) / _diviser;
        }
    }
}